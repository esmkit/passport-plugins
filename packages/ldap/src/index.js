 ...
 */
export const Strategy = function (options, verify) {
 ...
 * @returns {undefined}
 */
const handleErrorAsFailure = function (err) {
 ...
 * @returns {undefined}
 */
const handleAuthentication = function (req, options) {
	let username;
	let password;
	var ldap;
	var errorHandler;
...
Strategy.prototype.authenticate = function (req, options) {
	...
	const callback = function (err, configuration) {
		if (err) {
	...
	if (this.getOptions.length === 1) {
		// Accepts 1 parameter, backwards compatibility
		this.getOptions(callback.bind(this));
	} else {
		// Accepts 2 parameters, pass request as well
